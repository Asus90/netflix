...
class HoatAndNewData {
  ...
  factory HoatAndNewData.fromJson(Map<String, dynamic> json) {
    return _$HoatAndNewDataFromJson(json);
  }

  Map<String, dynamic> toJson() => _$HoatAndNewDataToJson(this);
}
